...
This repository contains a modified version of **[GridGraph](GRIDGRAPH_ORIGINAL_README.md)**  that implements a novel degree-based partitioning method. The goal is to improve the load balancing and overall performance of large-scale graph processing on a single machine.
